...
const DEFAULT_REPORT_DIR = process.platform === "win32" ? LOCAL_STAFF_REPORT_DIR : path.join(APP_DIR, "reports");
const STAFF_REPORT_DIR = process.env.REPORT_DIR || DEFAULT_REPORT_DIR;
